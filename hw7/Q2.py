...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.batch1 = nn.BatchNorm2d(4, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)

        self.conv2 = nn.Conv2d(4, 4, kernel_size=(3, 3), stride=(1, 1), padding=(1,1))
        self.batch2 = nn.BatchNorm2d(4, eps = 1e-5, momentum=0.1, affine=True, track_running_stats=True)# 6*6 from image dimension

        self.fc1 = nn.ReLU()
        self.fc2 = nn.Linear(196, 10, bias=True)
